...
public extension Project {
    static let appInfoPlist: [String: Plist.Value] = [
        ...
        "CFBundleVersion": "1",
        "CFBundleIdentifier": "\(Project.Environment.bundlePrefix)",
        "CFBundleDisplayName": "Coinity",
    ...
    static let demoInfoPlist: [String: Plist.Value] = [
        ...
        "CFBundleDevelopmentRegion": "ko",
        "CFBundleVersion": "1",
        "CFBundleIdentifier": "\(Project.Environment.bundlePrefix).demo",
        "CFBundleDisplayName": "Coinity Demo",
        "UILaunchStoryboardName": "LaunchScreen",
        "UIApplicationSceneManifest": [
            "UIApplicationSupportsMultipleScenes": false,
            "UISceneConfigurations": [
